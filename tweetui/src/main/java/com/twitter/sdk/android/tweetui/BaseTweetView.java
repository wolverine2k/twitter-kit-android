...
// TODO: fix these pmd warnings by (re)factoring this class
...
public abstract class BaseTweetView extends LinearLayout {
    ...
    /**
     * Initialize the metrics component and other components.
     * @throws IllegalStateException if TweetUi has not been started.
     */
    private void initComponents() {
        tweetViewMetric = getTweetViewMetric(dependencyProvider.getMetricsManager());
    }

    /**
     * Testing-purposes: Override to inject a mocked TweetViewMetric.
     * @return a TweetViewMetric
     */
    ...
    static class DependencyProvider {
        ...
        /*
         * TODO:
         * Reimplement getTweetRepository, currently unable to implement because of class
