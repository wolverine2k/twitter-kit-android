...
public final class TestFixtures {
    ...
    public static final List<Long> TWEET_IDS = new ArrayList<Long>();
    public static final List<Long> DUPLICATE_TWEET_IDS = new ArrayList<Long>();
    public static final List<Tweet> UNORDERED_TWEETS = new ArrayList<Tweet>();
    public static final List<Tweet> ORDERED_TWEETS = new ArrayList<Tweet>();
    public static final List<Tweet> ORDERED_DUPLICATE_TWEETS = new ArrayList<Tweet>();
    public static final List<Tweet> UNORDERED_DUPLICATE_TWEETS = new ArrayList<Tweet>();
    public static final List<Tweet> UNORDERED_MISSING_TWEETS = new ArrayList<Tweet>();
    public static final List<Tweet> ORDERED_MISSING_TWEETS = new ArrayList<Tweet>();
    ...
    static Tweet createPhotoTweet(long id, User user, String text, String timestamp,
        ...
        final ArrayList<MediaEntity> mediaEntities = new ArrayList<MediaEntity>();
